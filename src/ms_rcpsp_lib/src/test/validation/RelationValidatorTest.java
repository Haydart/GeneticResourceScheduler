...
import ms_rcpsp_lib.src.msrcpsp.validation.RelationValidator;
...
public class RelationValidatorTest {
  ...
  public void testValidate() {
    ...
    BaseValidator validator = new RelationValidator();
    assertEquals("Relation constraint should be violated", ValidationResult.FAILURE, validator.validate(schedule));
    ...
    assertEquals("Relation constraint should not be violated",
